...
import com.jblg.lillibrary.fragment.Chapter_Fragment;
import com.jblg.lillibrary.fragment.Comic_Fragment;
import com.jblg.lillibrary.fragment.ViewPagerAdapter;
...
public class detail_comic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final android.app.AlertDialog dialog =new SpotsDialog.Builder().setContext(this).setMessage("Please wait....").setCancelable(false).build();
        dialog.show();
